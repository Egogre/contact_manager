...
RSpec.describe PhoneNumbersController, type: :controller do
  ...
  before(:each) do
    Person.create!(first_name: "Billy", last_name: "Cosby")
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { number: '99878766543', person_id: 1 }
      }
      ...
      it "updates the requested phone_number" do
        ...
        phone_number.reload
        expect(phone_number.number).to eq('99878766543')
      end
      ...
      it "redirects to the phone_number's owner" do
        phone_number = PhoneNumber.create! valid_attributes
        put :update, {:id => phone_number.to_param, :phone_number => valid_attributes}, valid_session
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the phone_number's owner" do
      ...
      valid_attributes = {number: '123', person_id: bob.id}
      phone_number = PhoneNumber.create! valid_attributes
      delete :destroy, {:id => phone_number.to_param}, valid_session
